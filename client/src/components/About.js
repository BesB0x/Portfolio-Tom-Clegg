      ...
      <div className='about-container'>
        ...
        <section className='block '>
          ...
          <div className='text'>
            ...
            <h6 className='about-subtitle'> General Assembly</h6>
            <p>The bootcamp gave me a strong foundation of knowledge to build on and a direction as to which path I want to take into the industry. It also confirmed my belief that my skills of lateral thought, empathetic and compassionate communication, and creative determination stand me in good stead for a job in coding, and also that I have plenty left to learn! I am therefore looking for a full-stack position that stretches me intellectually and artistically, and allows me to learn from and work with others who are well established in their life.</p>
          </div>
        </section>
